...
namespace MetroMiles.PersistenceLayer.Migrations
{
    ...
    public partial class MigrateToAspNetIdentity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // RefreshTokens.Id/UserId switch from int to Guid — SQL Server can't ALTER an IDENTITY
            // column's type in place, so the table is dropped and recreated instead. Existing refresh
            // tokens are short-lived and safe to lose; every active session simply needs to log in
