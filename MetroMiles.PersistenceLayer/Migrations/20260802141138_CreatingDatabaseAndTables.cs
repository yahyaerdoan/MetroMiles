    ...
    public partial class CreatingDatabaseAndTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 0, new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), null, "admin@metromiles.com", "Admin", "MetroMiles", new byte[] { 215, 205, 2, 234, 175, 152, 107, 196, 193, 49, 18, 156, 181, 133, 39, 157, 153, 101, 83, 86, 161, 89, 232, 11, 235, 40, 179, 49, 11, 15, 137, 208 }, new byte[] { 88, 106, 194, 164, 64, 8, 0, 18, 250, 113, 212, 117, 14, 227, 36, 196 }, true, null });
