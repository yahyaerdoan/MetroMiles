...
public class MappingProfiles : Profile
{
    public MappingProfiles()
    {
        ...
        CreateMap<Car, GetByIdCarResponse>()
            .ForMember(destinationMember: d => d.ModelName, memberOptions: opt => opt.MapFrom(c => c.Model!.Name))
            .ForMember(destinationMember: d => d.BrandName, memberOptions: opt => opt.MapFrom(c => c.Model!.Brand!.Name))
            .ReverseMap();
